...
subprocess.Popen([r"X:\\SSG - Style Sheet Generator\\src\\dist\\ssg\\ssg.exe -t X:\\SSG - Style Sheet Generator\\src\\dist\\ssg\\resources\\dark.template -p .\\style\\palette.txt -o .\\style\\BreezeStyleSheets\\dark.qss"])
