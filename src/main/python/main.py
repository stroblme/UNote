...
class UNote(App):
    ...
    def connectReceivers(self):
        ...
        # Insert PDF Page
        self.ui.actionPageExtendActive.triggered.connect(lambda: self.receiversInst.pageExtendActive())
        ...
        # Find in PDF
        self.ui.actionPageFind.triggered.connect(lambda: self.receiversInst.pageFind())
